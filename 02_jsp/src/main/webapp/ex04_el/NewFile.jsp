...
<%--
  ...
  3. Data Bind 영역에 저장된 값만 EL 로 나타낼 수 있다.
    ...
    2) request     : HttpServletRequest : 요청 후 응답 전까지 접근 가능        : ${값}, ${requestScope.값} 값만 보통 적음
    3) session     : HttpSession        : 브라우저 닫기 전까지만 접근 가능     : ${값}, ${sessionScope.값} 세션은 명시해 줌
    4) application : ServletContext     : 애플리케이션 종료 전까지만 접근 가능 : ${값}, ${application.값}
                                          (사이트 문 닫기 전까지)
--%>
...
<%
  Map<String, Object> map = Map.of("title", "책", "author", "저자", "price", "가격");
